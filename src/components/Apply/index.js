...
const steps = ['OTP Verification','Personal Details', 'Address Details', 'Education', 'Preview'];
...
const Apply = (props) => {
  ...
  return (
    <div className="apply-form">
      ...
      <br/>
      <br/>
            {step === 0 && <Mail job={jobname} data={formData} onNext={handleNext} />}

      {step === 1 && <PersonalDetailsForm data={formData} onNext={handleNext} />}
